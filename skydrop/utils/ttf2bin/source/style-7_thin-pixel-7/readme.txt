...
True Type Font: Thin Pixel-7 version 1.0


EULA
-==-
The font Thin Pixel-7 is freeware for home using only.


DESCRIPTION
-=========-
Classic small pixel font. Size is 5*7 pixels. Latin and Cyrillic code pages are supported.

Files in thin_pixel-7.zip:
       	readme.txt     			this file;
        thin_pixel-7.ttf    		regular font;
	thin_pixel-7_screen.png		preview image.
