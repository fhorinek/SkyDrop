...
void (* gui_init_array[])() =
	...
	gui_set_menu_audio_init, gui_text_init, gui_set_advanced_init, gui_accelerometer_calib_init};
...
void (* gui_stop_array[])() =
	...
	gui_set_menu_audio_stop, gui_text_stop, gui_set_advanced_stop, gui_accelerometer_calib_stop };
...
void (* gui_loop_array[])() =
	...
	gui_set_menu_audio_loop, gui_text_loop, gui_set_advanced_loop, gui_accelerometer_calib_loop};
...
void (* gui_irqh_array[])(uint8_t type, uint8_t * buff) =
	...
	gui_set_menu_audio_irqh, gui_text_irqh, gui_set_advanced_irqh, gui_accelerometer_calib_irqh};
