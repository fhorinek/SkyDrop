...
{
	uint8_t lh = widget_label_P(PSTR("Azim"), x, y);
...
register_widget1(w_compass, "Azimuth", widget_compass_draw);
register_widget1(w_compass_arrow, "Compass", widget_compass_arrow_draw);
register_widget1(w_compass_heading, "Compass heading", widget_compass_heading_draw);
