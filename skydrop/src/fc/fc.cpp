 ...
 * (without altitude). All parameters must be given as fixed integers
 * multiplied with GPS_MULT.
 *
 * \param lat1 the latitude of the 1st GPS point
 * \param lon1 the longiitude of the 1st GPS point
 * \param lat2 the latitude of the 2nd GPS point
 * \param lon2 the longiitude of the 2nd GPS point
 *
 ...
 * (including altitude). Langitude and longitude parameters must be
