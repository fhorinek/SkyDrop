...
DWORD get_fattime (void)
{
	...
	time_from_epoch(time_get_actual(), &sec, &min, &hour, &day, &wday, &month, &year);
...
//	DUMP_REG(USARTF0.CTRLC);
	...
	if (ty) {			        // Initialization succeded
		sd_spi_usart.BecomeSPI(0, MSB, 16000000);
	}
