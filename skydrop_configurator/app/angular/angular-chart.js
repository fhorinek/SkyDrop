(function (factory) {
  ...
  function ChartJsFactory (ChartJs) {
    ...
    function createChart (type, scope, elem) {
      ...
      ['hover', 'click', "mousedown", "mouseup", "mouseout"].forEach(function (action) {
        if (scope[action]) 
        {
        	if (action == "hover")
        		cvs["onmousemove"] = getEventHandler(scope, chart, action);
        	if (action == "click")
        		cvs["onclick"] = getEventHandler(scope, chart, action);
        	if (action == "mousedown")
        		cvs["onmousedown"] = getEventHandler(scope, chart, action);
        	if (action == "mouseup")
        		cvs["onmouseup"] = getEventHandler(scope, chart, action);
        	if (action == "mouseout")
        		cvs["onmouseout"] = getEventHandler(scope, chart, action);
        }
      });
